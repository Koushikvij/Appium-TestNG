...
import com.automate.driver.enums.MobileFindBy;
...
import static com.automate.driver.enums.MobileFindBy.*;
...
public class ScreenActions {
  ...
  protected void scrollintoViewAndroid(String elementName)
  {
    ((AndroidDriver<MobileElement>) DriverManager.getDriver()).findElementByAndroidUIAutomator(
      "new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().className(\"android.widget.TextView\").text(\"" + elementName + "\"))");
  }
