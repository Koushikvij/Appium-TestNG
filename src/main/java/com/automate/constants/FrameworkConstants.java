...
public final class FrameworkConstants {
  ...
  public static final String TEST_RESOURCES_DIR = PROJECT_PATH + File.separator + "src\\test\\resources";
  public static final String ANDROID_APK_PATH =  TEST_RESOURCES_DIR + File.separator + "app" + File.separator +
  ...
  public static final String APPIUM_JS_PATH = System.getProperty("user.home") + File.separator + "node_modules\\appium\\build\\lib\\main.js";
  ...
  public static final String EXTENT_REPORT_PATH = PROJECT_PATH + File.separator + "extent-test-report";
