...
public final class ScreenRecordingUtils {
  ...
  public static void stopScreenRecording(String methodName) {
    ...
    File path = TestUtils.getLastModifiedDirectory(FrameworkConstants.EXTENT_REPORT_PATH);
    var pathToWriteVideoFile = path.getAbsolutePath() + File.separator + methodName + ".mp4";
